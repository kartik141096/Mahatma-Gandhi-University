...
if($GLOBALS['_SERVER']['SERVER_NAME'] == 'www.mgu.edu.in'){
    
    $config['base_url'] = 'https://www.mgu.edu.in/';    
}
elseif($GLOBALS['_SERVER']['SERVER_NAME'] == 'mgu.edu.in'){
    
    $config['base_url'] = 'https://mgu.edu.in/';
    
}
elseif($GLOBALS['_SERVER']['SERVER_NAME'] == '13.127.91.175'){
    
    $config['base_url'] = 'http://13.127.91.175/';
    
}else{

    $config['base_url'] = 'http://localhost/mgu/';
}
...
/*
|--------------------------------------------------------------------------
| SECURITY HEADERS Added By Kartik kaushik on 21/March/2024
|--------------------------------------------------------------------------
| 
| This is added due to security protocols so that attackers fails to do 
| cyber fraud with MGU
|
*/
